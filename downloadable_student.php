                ...
                <div class="span6" id="content">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<?php 	$query = mysqli_query($con,"SELECT * FROM files where class_id = '$get_id' order by fdatein DESC ")or die(mysqli_error());
								...
								?>
									...
									?>                              
										...
										<td width="30">
                                         ...
                                         <td width="30">
										 <a  data-placement="bottom" title="Descargar" id="<?php echo $id; ?>Descargar" href="<?php echo $row['floc']; ?>" target="_blank"><i class="icon-download icon-large"></i></a>
										 </td>            
