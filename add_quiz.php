                                ...
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Atrás</a>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" name="Descripcion" id="inputPassword" placeholder="Descripcion de Examen" required>
											</div>
										</div>										
										<div class="control-group">
										<div class="controls">										
										...
										mysqli_query($con,"insert into quiz (quiz_title,quiz_description,date_added,teacher_id) values('$quiz_title','$description',NOW(),'$session_id')")or die(mysqli_error());
										?>
										<script>
