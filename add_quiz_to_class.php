                                ...
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Atrás</a>
										...
										<div class="control-group">
											<label class="control-label" for="inputEmail">Practica</label>
											<div class="controls">
											<select name="quiz_id">
											<option></option>
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword">Tiempo Práctica (en minutos)</label>
											<div class="controls">
											<input type="text" class="span3" name="time" id="inputPassword" placeholder="Tiempo Práctica" required>
											</div>
										</div>
