					  ...
					  <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<form method="post">
								<textarea name="content" id="ckeditor_source" style="width:75%; height:120px"></textarea>
								<br>
								...
								<?php
									...
									mysqli_query($con,"insert into teacher_class_announcements (teacher_class_id,teacher_id,content,date) values('$get_id','$session_id','$content',NOW())")or die(mysqli_error());
									mysqli_query($con,"insert into notification (teacher_class_id,notification,date_of_notification,link) value('$get_id','Add Annoucements',NOW(),'announcements_student.php')")or die(mysqli_error());
									?>
									<script>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								 ...
								 ?>
											...
											<div class="pull-right">
												<form method="post" action="edit_video.php<?php echo '?id='.$get_id; ?>">
