                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    ...
                                    <th></th>
										...
										<tbody>
												 <?php
                                    $teacher_query = mysqli_query($con,"select * from teacher") or die(mysql_error());
									...
									<?php }else{ ?>
									<td width="120"><a href="edit_teacher.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-check"></i> Activar</a></td>				
									<?php } ?>
                                </tr>
                            <?php } ?>
