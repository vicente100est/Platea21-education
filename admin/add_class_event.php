...
if (isset($_POST['add'])){
	...
	$query = mysqli_query($con,"insert into event (date_end,date_start,event_title) values('$date_end','$date_start','$title')")or die(mysql_error());
	?>
	<script>
...
?>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
									...
									<?php $event_query = mysqli_query($con,"select * from event where teacher_class_id = '' ")or die(mysql_error());
