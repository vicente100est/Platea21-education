   <div class="row-fluid">
       <a href="class.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i>Añadir Aula</a>
                        ...
                        <div class="block">
							...
							<?php
							$query = mysqli_query($con,"select * from class where class_id = '$get_id'")or die(mysql_error());
...
mysqli_query($con,"update class set class_name = '$class_name' where class_id = '$get_id' ")or die(mysql_error());
?>
