   <div class="row-fluid">
       <a href="students.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Agregar Estudiante</a>
                        ...
                        <div class="block">
							...
							<?php
							$query = mysqli_query($con,"select * from student LEFT JOIN class ON class.class_id = student.class_id where student_id = '$get_id'")or die(mysql_error());
	      ...
	      <?php
                            if (isset($_POST['update'])) {
								...
								mysqli_query($con,"update student set username = '$un' , firstname ='$fn' , lastname = '$ln' , class_id = '$cys' where student_id = '$get_id' ")or die(mysql_error());
