        ...
        <div class="container-fluid">
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
								$query = mysqli_query($con,"SELECT * from student where student_id = '$session_id'")or die(mysqli_error());
			...
			jQuery("#change_password").submit(function(e){
					e.preventDefault();
						...
						{
						$.jGrowl("Password does not match with your current password  ", { header: 'Cambiar Contraseña Failed' });
						}else if  (new_password != retype_password){
						$.jGrowl("Password does not match with your new password  ", { header: 'Cambiar Contraseña Failed' });
					...
					$.ajax({
						...
						$.jGrowl("Your password is successfully change", { header: 'Cambiar Contraseña Success' });
						var delay = 2000;
